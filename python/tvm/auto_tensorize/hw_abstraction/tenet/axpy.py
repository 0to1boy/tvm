...
@register_abstraction("tenet axpy", "tenet::axpy::store_vector")
class TenetAxpyStoreVector(MemoryAbstraction):
...
@register_abstraction("tenet axpy", "tenet::axpy::load_a")
class TenetAxpyLoadA(MemoryAbstraction):
    def get_params_usage(self):
        """
        ---
        Returns:
...
@register_abstraction("tenet axpy", "tenet::axpy::load_vector")
class TenetAxpyLoadVector(MemoryAbstraction):
    def get_params_usage(self):
        """
        ---
        Returns:
...
@register_abstraction("tenet axpy", "tenet::axpy::mul")
class TenetAxpyMul(ComputeAbstraction):
    def get_params_usage(self):
        """
        ---
        Returns:
