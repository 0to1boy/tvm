...
import time
@register_abstraction("cuda", "nvcuda::wmma::store_matrix_sync")
class WMMAStoreMatrixSync(MemoryAbstraction):
    ...
    def get_buffer_memory_scope_info(self, arg_pos=0, args=None):
        ...
        if arg_pos == 0:
            ...
            ret["storage_alignment"] = "nvcuda::wmma::accumulator"
...
@register_abstraction("cuda", "nvcuda::wmma::load_matrix_sync")
class WMMALoadMatrixSync(MemoryAbstraction):
    def get_params_usage(self):
        """
        ---
        Returns:
...
@register_abstraction("cuda", "nvcuda::wmma::fill_fragment")
class WMMAFillFragment(ComputeAbstraction):
    def get_params_usage(self):
        """
        ---
        Returns:
...
@register_abstraction("cuda", "nvcuda::wmma::mma_sync")
class WMMAMmaSync(ComputeAbstraction):
    def get_params_usage(self):
        """
        ---
        Returns:
    ...
    def get_buffer_memory_scope_info(self, arg_pos=0, args=None):
        ...
        if arg_pos == 0:
            ...
            assert isinstance(args, list) and len(args) == 9
            ret["storage_alignment"] = "nvcuda::wmma::matrix_a"
            ret["target"] = "cuda"
            ret["hw_abs_dag_mnemonic"] = self.belong_hw_abs_dag_name
        elif arg_pos == 4:
            assert isinstance(args, list) and len(args) == 9
            ret["storage_alignment"] = "nvcuda::wmma::matrix_b"
            ret["target"] = "cuda"
            ret["hw_abs_dag_mnemonic"] = self.belong_hw_abs_dag_name
        elif arg_pos == 6:
            assert isinstance(args, list) and len(args) == 9
