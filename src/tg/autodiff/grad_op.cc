...
class GradOp : public ExprMutator {
 ...
 public:
  ...
  PrimExpr VisitExpr_(const BufferLoadNode* op) NOT_IMPLEMENTED PrimExpr
 ...
 protected:
  void VisitExpr_(const VarNode* op) override {
    ...
    tensor_list.push_back(
        te::compute(shape_, func, generator_.unique_name(tensor_name_key_), tag, {}));
  }

  void VisitExpr_(const SizeVarNode* op) override UNEXPECTED
  // void VisitExpr_(const BufferLoad* op) override UNEXPECTED
