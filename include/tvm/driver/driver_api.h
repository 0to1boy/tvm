...
//  */
TVM_DLL tvm::transform::Sequential MixedModulePassManager(IRModule mixed_mod, Target target);
 ...
 */
TVM_DLL tvm::transform::Sequential DeviceModulePassManager(IRModule mixed_mod, Target target);
 ...
 */
TVM_DLL tvm::transform::Sequential HostModulePassManager(IRModule mixed_mod, Target target_host);
