...
def mapping_tensorcore(
    ...
    while turn_trails < total_trails:
        ...
        if (turn_trails + trails_per_workload) > total_trails :
            trails_per_workload = total_trails - turn_trails
...
example_text = """
 example:
    python mapping_gemm_GTA.py --in_dtype float16 --out_dtype float16 --begin 0 --num 1 --trials 20
    python mapping_gemm_GTA.py --in_dtype float16 --out_dtype float32 --begin 0 --num 1 --trials 20
    python mapping_gemm_GTA.py --in_dtype float32 --out_dtype float32 --begin 0 --num 1 --trials 20
"""
