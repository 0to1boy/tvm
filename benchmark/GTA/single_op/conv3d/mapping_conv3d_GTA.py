...
def mapping_tensorcore(
    ...
    log_file = "conv3d-%s-%s-layer-%s-GTA.log" % (in_dtype, out_dtype, layer)
    target_device = "cuda"
...
example_text = """
 example:
    python mapping_conv3d_GTA.py --in_dtype float16 --out_dtype float16 --begin 0 --num 1 --trials 20
    python mapping_conv3d_GTA.py --in_dtype float16 --out_dtype float32 --begin 0 --num 1 --trials 20
    python mapping_conv3d_GTA.py --in_dtype float32 --out_dtype float32 --begin 0 --num 1 --trials 20
"""
