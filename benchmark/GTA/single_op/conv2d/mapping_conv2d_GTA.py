...
def mapping_tensorcore(
    ...
    log_file = "conv2d-%s-%s-%s-layer-%s-GTA.log" % (layout, in_dtype, out_dtype, layer)
    # target_device = "llvm -mcpu=skylake-avx512"
    target_device = "cuda"
...
example_text = """
 example:
    python mapping_conv2d_GTA.py --in_dtype float16 --out_dtype float16 --begin 0 --num 1 --trials 20
    python mapping_conv2d_GTA.py --in_dtype float16 --out_dtype float32 --begin 0 --num 1 --trials 20
    python mapping_conv2d_GTA.py --in_dtype float32 --out_dtype float32 --begin 0 --num 1 --trials 20
"""
