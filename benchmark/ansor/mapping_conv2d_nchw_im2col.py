...
def run(
    ...
    log_dir = "conv2d-%s-%s-layer-%s.json" % (in_dtype, out_dtype, layer)
...
example_text = """
 example:
    python conv2d_nchw_im2col.py --in_dtype float16 --out_dtype float16 --begin 0 --num 1 --trials 20
    python conv2d_nchw_im2col.py --in_dtype float16 --out_dtype float32 --begin 0 --num 1 --trials 20
    python conv2d_nchw_im2col.py --in_dtype float32 --out_dtype float32 --begin 0 --num 1 --trials 20
"""
